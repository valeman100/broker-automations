...
export default function AboutSection() {
  ...
  return (
    <section id="chi-sono" className="bg-[#f8f9fa] py-20 px-4">
      <div
        ref={ref}
      ...
      >
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1a1a2e] mb-8">
          Chi sono
        </h2>

        <div className="flex flex-col md:flex-row gap-10 items-start">
          {/* Spazio per foto profilo (opzionale) */}
          <div className="flex-shrink-0 hidden md:block">
            <div className="w-[120px] h-[120px] rounded-full bg-[#e2e8f0] flex items-center justify-center text-[#94a3b8]">
          ...
          <div className="flex-1">
            ...
            <p className="text-base md:text-lg text-[#64748b] leading-[1.7]">
